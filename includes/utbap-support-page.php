...
if( isset($_POST['submit']) ){
	...
	if($formok){
		...
		$emailbody = "<p>YouTube Channel Support (Free Version).</p>
		...
		mail("arrowplugins@gmail.com","YouTube Channel Support (Free Version)",$emailbody,$headers);
...
Your message has been sent successfully, Our support team will be in touch with you very soon.</p>
            <form method="post" action="">
                ...
                <o>Example: http://www.website.com</o>
                <input type="url" id="telephone" name="telephone" value="<?php echo ($sr && !$cf['form_ok']) ? $cf['posted_form_data']['telephone'] : '' ?>" />
